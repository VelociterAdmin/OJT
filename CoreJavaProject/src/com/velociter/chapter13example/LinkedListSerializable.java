...
class LinkedListSerializable<T extends Serializable> implements Serializable {
	// Default constructor - creates an empty list
	public LinkedListSerializable() {
	}

	// Constructor to create a list containing one object
	public LinkedListSerializable(T item) {
		if (item != null) {
	...
	public LinkedListSerializable(T[] items) {
		if (items != null) {
