...
public class ReverseThePeragraph {
	...
	public static void main(String[] args) {
		...
		String text = "You can extract a character from a String object by using the charAt() method. This accepts an integer argument that is the offset of the character position from the beginning of the string — in other words";				
